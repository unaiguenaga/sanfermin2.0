...
INSERT INTO `Joalduna` VALUES (100,'2013-12-10',250,2.3,'gorria',1),(101,'2013-03-15',256,2.4,'beltza',1),(102,'2013-10-06',302,2.1,'marroia',2),(103,'2012-09-26',223,2.56,'zuria',2),(104,'2013-02-10',285,2.4,'beltza',2),(105,'2013-07-20',260,2.24,'marroia',3);
...
CREATE TABLE `tratamendua` (
  ...
  CONSTRAINT `fk_tratamendua_2` FOREIGN KEY (`fk_botika`) REFERENCES `botika` (`kodea`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `zezena` VALUES (1000,'2013-09-10','Islero',250,2.3,1.02,1),(1001,'2013-10-15','Raton',256,2.4,1.52,1),(1002,'2013-11-06','Atrevido',302,2.1,1.06,1),(1003,'2012-01-26','Belador',223,2.56,1.32,2),(1004,'2013-10-10','Sedoso',285,2.4,0.98,2),(1005,'2013-02-20','Cimbareto',260,2.24,1.1,3),(1006,'2013-03-10','Desteñido',280,2.01,1.25,4);
...
-- Dump completed on 2014-12-19 16:11:35
